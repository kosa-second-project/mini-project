            ...
            <body class="app-shell">
                            ...
                            <div class="d-flex align-items-center gap-3">
                                <div class="text-end d-none d-sm-block">
                                    <div class="fw-bold text-dark">
                                        <c:out value="${sessionScope.loginUser.ename}" /> <span
                                            class="small text-muted font-monospace">[
                                            <c:out value="${sessionScope.loginUser.empno}" />]
                                        </span>
                                    </div>
                                    <div class="small text-secondary">
                                        <c:out value="${sessionScope.loginUser.deptname}" /> ·
                                        <c:out value="${sessionScope.loginUser.position}" />
                                    </div>
                                </div>
                                <span
                                    class="badge ${sessionScope.loginUser.role eq 'ADMIN' ? 'badge-admin' : 'badge-user'}">
                                    <c:choose>
                                        <c:when test="${sessionScope.loginUser.role eq 'ADMIN'}"><i
                                                class="bi bi-award me-1"></i>대표</c:when>
                                        <c:otherwise><i class="bi bi-person me-1"></i>사원</c:otherwise>
                                    </c:choose>
                                </span>
                                <a href="Logout.emp" class="btn btn-outline-danger btn-actions"><i
                                        class="bi bi-box-arrow-right me-1"></i>로그아웃</a>
                            </div>
                        </div>
                    </div>
                </nav>
                ...
                <div class="container pb-5">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <div class="d-flex align-items-center gap-2">
                            <label for="pageSizeSelect" class="form-label small fw-bold m-0 text-secondary"
                                style="white-space: nowrap;">보기 개수:</label>
                            ...
                            <div class="modal-content">
                                <div class="modal-header bg-light">
                                    <h5 class="modal-title fw-bold"><i
                                            class="bi bi-person-plus text-primary me-2"></i>신규 사원 등록</h5>
                                ...
                                <form id="insertForm" novalidate>
                                    <div class="modal-body p-4">
                                        <div class="row g-3">
                                            <div class="col-md-6">
                                                ...
                                                <input type="number" class="form-control" name="empno" required
                                                    placeholder="예: 1101">
                                            </div>
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <select class="form-select" name="deptno" id="insertDeptSelect"
                                                    required>
                                    ...
                                    <div class="modal-footer bg-light border-top">
                                        ...
                                        <button type="submit" class="btn btn-primary"><i
                                                class="bi bi-check-lg me-1"></i>등록 완료</button>
                                    </div>
                                </form>
                            </div>
                        </div>
                ...
                <div class="modal fade" id="detailModal" tabindex="-1" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered modal-lg">
                        <div class="modal-content">
                            <div class="modal-header bg-light">
                                <h5 class="modal-title fw-bold"><i class="bi bi-person-vcard text-primary me-2"></i>사원
                                    상세 정보</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                    aria-label="Close"></button>
                            </div>
                            <form id="detailForm" novalidate>
                                <div class="modal-body p-4">
                                    <div class="row g-3">
                                        <div class="col-md-6">
                                            ...
                                            <input type="number" class="form-control" id="detailEmpno" name="empno"
                                                readonly>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label small fw-bold">사원이름</label>
                                            <input type="text" class="form-control" id="detailEname" name="ename"
                                                required>
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        <c:if test="${sessionScope.loginUser.role eq 'ADMIN'}">
                                            <div class="col-md-6">
                                                ...
                                                <input type="password" class="form-control" id="detailPwd" name="pwd"
                                                    placeholder="비워둘 시 기존 패스워드 유지">
                                            </div>
                                        </c:if>
                                    </div>
                                </div>
                                <div class="modal-footer bg-light border-top justify-content-between">
                                    <div>
                                        <!-- 대표만 삭제 가능 -->
                                        <c:if test="${sessionScope.loginUser.role eq 'ADMIN'}">
                                            <button type="button" class="btn btn-danger" onclick="deleteEmp()"><i
                                                    class="bi bi-trash3 me-1"></i>사원 삭제</button>
                                        </c:if>
                                    </div>
                                    <div class="d-flex gap-2">
                                        ...
                                        <c:if test="${sessionScope.loginUser.role eq 'ADMIN'}">
                                            <button type="submit" class="btn btn-primary"><i
                                                    class="bi bi-floppy me-1"></i>정보 수정</button>
                                        </c:if>
                                    </div>
                                </div>
                            </form>
                ...
                <div class="toast-container">
                    <div id="liveToast" class="toast custom-toast hide" role="alert" aria-live="assertive"
                        aria-atomic="true">
